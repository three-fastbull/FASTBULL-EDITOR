...
> **FASTBULL-EDITOR:** This repository includes FASTBULL's local HyperFrames
> runtime, offline GSAP support, and Thai typography fallback. See
> [FASTBULL_EDITOR.md](FASTBULL_EDITOR.md) for the one-command setup.
